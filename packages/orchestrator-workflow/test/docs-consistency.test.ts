...
const SIBLING_GUARD_BUNDLE_ALLOWLIST: SiblingGuardAllowlistEntry[] = [
  ...
  },
  {
    ...
    uncitedLines: [913],
    claim:
      "the sentence describes the per-template asset read driven by `listTemplateNames()`; line 893 is the read of a templates-directory asset, while uncited 913 reads the skill asset for a different install step the sentence never mentions.",
  },
  {
    doc: "install-fence-mechanics.md",
    kind: "wrong-sibling-anchor",
  ...
  },
  {
    ...
    uncitedLines: [887],
    claim:
      "the sentence is explicitly about the path-exists-and-unedited branch; line 879 records the hash inside that branch's own `if`, while uncited 887 is the path-does-not-exist branch's record, which the sentence's own wording excludes.",
  },
  {
    doc: "install-fence-mechanics.md",
    kind: "wrong-sibling-anchor",
  ...
  },
  {
    ...
    uncitedLines: [1058],
    claim:
      "the :156 sentence names the effort-line computation call and the model argument it is computed from; line 1054 is that argument, while uncited 1058 passes the computed local into the agent-composition call that the separately cited `init.ts:930-1058` sentence describes.",
  },
  {
    doc: "model-preselection.md",
    kind: "wrong-sibling-anchor",
  ...
  },
  {
    ...
    uncitedLines: [117],
    claim:
      "the sentence names the `--json` subset interface by name; line 133 is that interface's own field declaration, while uncited 117 is the identical field on the superset interface the very same sentence contrasts it against.",
  },
  {
    doc: "install-fence-mechanics.md",
    kind: "distant-duplicate-anchor",
    ...
    uncitedLines: [916],
    claim:
      'line 893 cites `readAsset(join("templates", name)),`; uncited 916 is instead line 916 in `content: readAsset(join("skill", "references", name)),`, a different site the citing sentence never names.',
  },
  {
    doc: "install-fence-mechanics.md",
    kind: "distant-duplicate-anchor",
    ...
    uncitedLines: [515],
    claim:
      "line 989 cites `composeClaudeAgentVariant(`; uncited 515 is instead line 515 in `function composeClaudeAgentVariant(`, a different site the citing sentence never names.",
  },
  {
    doc: "install-fence-mechanics.md",
    kind: "distant-duplicate-anchor",
    ...
    uncitedLines: [484],
    claim:
      "the sentence describes `effortLine` being passed into `composeOpencodeAgentVariant` as a parameter; line 604 is that function's own effortLine push, while uncited 484 is the byte-identical push inside `composeOpencodeAgent`, the default (non-variant) composer the sentence does not name.",
  },
  {
    doc: "install-fence-mechanics.md",
    kind: "distant-duplicate-anchor",
  ...
  },
  {
    ...
    uncitedLines: [92],
    claim:
      "the sentence describes `Manifest`'s own persisted `routing` field; line 155 is that field's declaration inside the `Manifest` interface, while uncited 92 is the byte-identical declaration inside `InitOptions`, the install-input type the sentence does not name.",
  },
  {
    doc: "install-fence-mechanics.md",
    kind: "distant-duplicate-anchor",
  ...
  },
  {
    ...
    uncitedLines: [945],
    claim:
      "line 882 cites `installedFiles[relativePath] = recorded;`; uncited 945 is instead line 945 in `if (recorded !== undefined) installedFiles[relativePath] = recorded;`, a different site the citing sentence never names.",
  },
  {
    doc: "install-fence-mechanics.md",
    kind: "distant-duplicate-anchor",
  ...
  },
  {
    ...
    uncitedLines: [530],
    claim:
      "the sentence describes `composeClaudeAgent`'s read-only-roles push; line 453 is that function's own push, while uncited 530 is the byte-identical push inside `composeClaudeAgentVariant`, the tier-variant sibling covered separately under \"Composition\" below, which this sentence does not name.",
  },
  {
    doc: "model-preselection.md",
    kind: "distant-duplicate-anchor",
    ...
    uncitedLines: [530],
    claim:
      "the sentence names the read-only roles getting `disallowedTools:` right after `effort:` inside `composeClaudeAgent`; line 453 is that function's own push, while uncited 530 is the byte-identical push inside `composeClaudeAgentVariant`, the tier-variant sibling this sentence does not name.",
  },
  {
    doc: "model-preselection.md",
    kind: "distant-duplicate-anchor",
  ...
  },
  {
    ...
    uncitedLines: [607],
    claim:
      "the sentence describes `composeOpencodeAgent`'s read-only-roles push (`permission:`/`edit: deny`); line 487 is that function's own push, while uncited 607 is the byte-identical push inside `composeOpencodeAgentVariant`, the tier-variant sibling covered separately under \"Composition\" below, which this sentence does not name.",
  },
  {
    doc: "model-preselection.md",
    kind: "distant-duplicate-anchor",
  ...
  },
  {
    ...
    uncitedLines: [487],
    claim:
      "the sentence describes `composeOpencodeAgentVariant`'s own read-only-roles push; line 607 is that function's own push, while uncited 487 is the byte-identical push inside `composeOpencodeAgent`, the default (non-variant) composer this sentence does not name.",
  },
  {
    doc: "model-preselection.md",
    kind: "distant-duplicate-anchor",
  ...
  },
  {
    ...
    uncitedLines: [530],
    claim:
      "the sentence names `composeClaudeAgent` as the function 0.22.0 gave a pinned `effort:` line; line 453 is that function's own read-only-roles push, included in the cited range, while uncited 530 is the byte-identical push inside `composeClaudeAgentVariant`, the tier-variant sibling this sentence does not name.",
  },
  {
    doc: "model-preselection.md",
    kind: "distant-duplicate-anchor",
    ...
    uncitedLines: [607],
    claim:
      "the sentence names `composeOpencodeAgent` as the function 0.22.0 gave a pinned effort line; line 487 is that function's own read-only-roles push, included in the cited range, while uncited 607 is the byte-identical push inside `composeOpencodeAgentVariant`, the tier-variant sibling this sentence does not name.",
  },
  {
    doc: "model-preselection.md",
    kind: "distant-duplicate-anchor",
  ...
  },
  {
    ...
    uncitedLines: [519],
    claim:
      "line 687 cites `: 0;`; uncited 519 is instead line 519 in `return Array.isArray(candidate.targets) ? candidate.targets.length : …`, a different site the citing sentence never names.",
  },
  {
    doc: "operator-install-and-registry.md",
    kind: "distant-duplicate-anchor",
