...
const SIBLING_GUARD_BUNDLE_ALLOWLIST: SiblingGuardAllowlistEntry[] = [
  ...
  },
  {
    ...
    uncitedLines: [985],
    claim:
      "the sentence describes the per-template asset read driven by `listTemplateNames()`; line 965 is the read of a templates-directory asset, while uncited 985 reads the skill asset for a different install step the sentence never mentions.",
  },
  {
    doc: "install-fence-mechanics.md",
    kind: "wrong-sibling-anchor",
  ...
  },
  {
    ...
    uncitedLines: [959],
    claim:
      "the sentence is explicitly about the path-exists-and-unedited branch; line 951 records the hash inside that branch's own `if`, while uncited 959 is the path-does-not-exist branch's record, which the sentence's own wording excludes.",
  },
  {
    doc: "install-fence-mechanics.md",
    kind: "wrong-sibling-anchor",
  ...
  },
  {
    ...
    uncitedLines: [1130],
    claim:
      "the :156 sentence names the effort-line computation call and the model argument it is computed from; line 1126 is that argument, while uncited 1130 passes the computed local into the agent-composition call that the separately cited `init.ts:1128-1130` sentence describes.",
  },
  {
    doc: "model-preselection.md",
    kind: "wrong-sibling-anchor",
  ...
  },
  {
    ...
    uncitedLines: [988],
    claim:
      'line 965 cites `readAsset(join("templates", name)),`; uncited 988 is instead line 988 in `content: readAsset(join("skill", "references", name)),`, a different site the citing sentence never names.',
  },
  {
    doc: "install-fence-mechanics.md",
    kind: "distant-duplicate-anchor",
    ...
    uncitedLines: [587],
    claim:
      "line 1061 cites `composeClaudeAgentVariant(`; uncited 587 is instead line 587 in `function composeClaudeAgentVariant(`, a different site the citing sentence never names.",
  },
  {
    doc: "install-fence-mechanics.md",
    kind: "distant-duplicate-anchor",
    ...
    uncitedLines: [556],
    claim:
      "the sentence describes `effortLine` being passed into `composeOpencodeAgentVariant` as a parameter; line 676 is that function's own effortLine push, while uncited 556 is the byte-identical push inside `composeOpencodeAgent`, the default (non-variant) composer the sentence does not name.",
  },
  {
    doc: "install-fence-mechanics.md",
    kind: "distant-duplicate-anchor",
  ...
  },
  {
    ...
    uncitedLines: [1017],
    claim:
      "line 954 cites `installedFiles[relativePath] = recorded;`; uncited 1017 is instead line 1017 in `if (recorded !== undefined) installedFiles[relativePath] = recorded;`, a different site the citing sentence never names.",
  },
  {
    doc: "install-fence-mechanics.md",
    kind: "distant-duplicate-anchor",
  ...
  },
  {
    ...
    uncitedLines: [602],
    claim:
      "the sentence describes `composeClaudeAgent`'s read-only-roles push; line 525 is that function's own push, while uncited 602 is the byte-identical push inside `composeClaudeAgentVariant`, the tier-variant sibling covered separately under \"Composition\" below, which this sentence does not name.",
  },
  {
    doc: "model-preselection.md",
    kind: "distant-duplicate-anchor",
    ...
    uncitedLines: [602],
    claim:
      "the sentence names the read-only roles getting `disallowedTools:` right after `effort:` inside `composeClaudeAgent`; line 525 is that function's own push, while uncited 602 is the byte-identical push inside `composeClaudeAgentVariant`, the tier-variant sibling this sentence does not name.",
  },
  {
    doc: "model-preselection.md",
    kind: "distant-duplicate-anchor",
  ...
  },
  {
    ...
    uncitedLines: [679],
    claim:
      "the sentence describes `composeOpencodeAgent`'s read-only-roles push (`permission:`/`edit: deny`); line 559 is that function's own push, while uncited 679 is the byte-identical push inside `composeOpencodeAgentVariant`, the tier-variant sibling covered separately under \"Composition\" below, which this sentence does not name.",
  },
  {
    doc: "model-preselection.md",
    kind: "distant-duplicate-anchor",
  ...
  },
  {
    ...
    uncitedLines: [559],
    claim:
      "the sentence describes `composeOpencodeAgentVariant`'s own read-only-roles push; line 679 is that function's own push, while uncited 559 is the byte-identical push inside `composeOpencodeAgent`, the default (non-variant) composer this sentence does not name.",
  },
  {
    doc: "model-preselection.md",
    kind: "distant-duplicate-anchor",
  ...
  },
  {
    ...
    uncitedLines: [602],
    claim:
      "the sentence names `composeClaudeAgent` as the function 0.22.0 gave a pinned `effort:` line; line 525 is that function's own read-only-roles push, included in the cited range, while uncited 602 is the byte-identical push inside `composeClaudeAgentVariant`, the tier-variant sibling this sentence does not name.",
  },
  {
    doc: "model-preselection.md",
    kind: "distant-duplicate-anchor",
    ...
    uncitedLines: [679],
    claim:
      "the sentence names `composeOpencodeAgent` as the function 0.22.0 gave a pinned effort line; line 559 is that function's own read-only-roles push, included in the cited range, while uncited 679 is the byte-identical push inside `composeOpencodeAgentVariant`, the tier-variant sibling this sentence does not name.",
  },
  {
    doc: "model-preselection.md",
    kind: "distant-duplicate-anchor",
