...
- 2026-09-21T05:21:32.000Z (agent-dx tracker task
  ...
  `test/docs-consistency.test.ts:8282#"const lines = stripSelfAllowlistSpan(readFile(entry.real)).split"`
  killed by the new fixture above; rule (c)'s uniqueness check neutralised
  at `test/docs-consistency.test.ts:6215#"if (distantLines.length > 0) {"`
  ...
  `test/docs-consistency.test.ts:6090#"const startIdx = content.lastIndexOf(startMarker);"`
  ...
  `test/docs-consistency.test.ts:5007#"both copies' mutation_probes block has exactly the eleven sub-fields in a fixed order"`,
  `test/docs-consistency.test.ts:3658#"in-scope citations (sanity: the brake itself did not go blind"`,
  `test/docs-consistency.test.ts:10367#"anchored full citations of docs/okf/log.md"`,
  `test/docs-consistency.test.ts:5738#"function citationScanParagraphs("`,
  and `test/docs-consistency.test.ts:10019#"function resolveLogCitationPath("`;
  none are path-less continuation forms, since `checkLogCitations` forbids
  that form in this file outright (`test/docs-consistency.test.ts:10138#"path-less continuation citation form is forbidden in docs/okf/log.md"`)
...
- 2026-09-12T06:30:04Z (mutation probe definition fields, agent-dx task
  ...
  (`implementer.md:224#"expectation: met | violated | not_applicable"`,
  ...
  (`implementer.md:119#"take the definition fields from that"`).
...
- 2026-09-12T05:32:21Z (mutation probe definition fields, agent-dx task
  ...
  (`CHANGELOG.md:377#"The implementer"`).
...
- 2026-09-08T11:05:00Z (citation scanning goes paragraph-joined, the
  ...
  with a stale anchor
  (`test/docs-consistency.test.ts:10215#"is still checked (a stale wrapped anchor fails)"`)
  and a wrapped continuation form
  (`test/docs-consistency.test.ts:10231#"that wraps across a hard line break is still flagged"`),
  ...
  (`test/docs-consistency.test.ts:10252#"throws instead of silently excusing every citation"`)
  ...
  (`test/docs-consistency.test.ts:3565#"function collectBrakeScan("`,
  `test/docs-consistency.test.ts:3809#"function collectFullTestCitations("`),
  ...
  (`test/docs-consistency.test.ts:3618#"raises the brake's examined count by exactly one"`):
  ...
  (`test/docs-consistency.test.ts:10019#"function resolveLogCitationPath("`):
  ...
  (`test/docs-consistency.test.ts:10266#"escaping the repository with a"`,
  `test/docs-consistency.test.ts:10311#"is reported ambiguous, not silently bound"`).
  ...
  `CHANGELOG.md:754#"Citation scanning is paragraph-joined"`. Verified on
...
- 2026-09-08T10:20:55Z (citation-sibling-drift guard, review round 3 fixes
  ...
  filter
  (`test/docs-consistency.test.ts:3341#"function collectStringAnchoredCitations("`)
  ...
  source-span pin
  (`test/docs-consistency.test.ts:9882#"resolution sites stay wired to extractSiblingGuardCitations"`)
  ...
  (`test/docs-consistency.test.ts:3382#"a resolved continuation citation survives collectStringAnchoredCitations"`)
  driving it against
  ...
  `test/docs-consistency.test.ts:9957#"log.md's own citations resolve, and it carries no path-less continuation citation form"`,
  ...
  (`test/docs-consistency.test.ts:10076#"function checkLogCitations("`)
...
- 2026-09-08T08:47:30Z (citation-sibling-drift guard, continuation-citation
  ...
  `test/docs-consistency.test.ts:3134#"const ANCHOR_CONTINUATION_CITATION_RE ="`
  ...
  `test/docs-consistency.test.ts:5805#"function extractSiblingGuardCitations("`,
...
- 2026-09-06T21:33:40Z (task 0e17fb63, review round 2 fix round, two
  ...
  `test/docs-consistency.test.ts:4917#"resolve it before the next reviewer spawn"`, a
...
- 2026-09-06T21:10:29Z (task 0e17fb63, review round 1 fix round, six
  ...
  (`test/docs-consistency.test.ts:4602#"never end your turn with the run still outstanding"`).
...
`packages/orchestrator-workflow/assets/skill/references/evidence-and-probes.md:246#"without a bundle are unaffected"`).
...
by later rounds, `CHANGELOG.md:377#"The implementer"`) and from line
556 to line 575 (moved again to line 673,
`CHANGELOG.md:754#"Citation scanning is paragraph-joined"`); both were
...
round, `CHANGELOG.md:377#"The implementer"`) and from line 575 to line 579
(moved again to line 673, `CHANGELOG.md:754#"Citation scanning is paragraph-joined"`); both were
...
later change, `CHANGELOG.md:377#"The implementer"`) and from line 579 to
line 598 (moved again to line 673,
`CHANGELOG.md:754#"Citation scanning is paragraph-joined"`), in the two
...
later change, `CHANGELOG.md:377#"The implementer"`) and from line 598 to
line 637 (moved again to line 673,
`CHANGELOG.md:754#"Citation scanning is paragraph-joined"`), in the live
...
later change, `CHANGELOG.md:377#"The implementer"`) and from line 637 to
...
from line 294 to line 296 (`CHANGELOG.md:377#"The implementer"`) and from
...
(`CHANGELOG.md:377#"The implementer"`) and from line 690 to line 718
(`CHANGELOG.md:754#"Citation scanning is paragraph-joined"`); both were
...
(`CHANGELOG.md:377#"The implementer"`) and from line 723 to line 728
(`CHANGELOG.md:754#"Citation scanning is paragraph-joined"`); both were
re-pointed mechanically after checking that each anchor sits on its new
line, in the live sites and in the earlier entries that quote them.
Re-stamped the bundle docs whose `sources:` list `CHANGELOG.md` after
