...
- 2026-09-12T05:32:21Z (mutation probe definition fields, agent-dx task
  ...
  (`CHANGELOG.md:557#"The implementer"`).
...
- 2026-09-08T11:05:00Z (citation scanning goes paragraph-joined, the
  ...
  `CHANGELOG.md:934#"Citation scanning is paragraph-joined"`. Verified on
...
by later rounds, `CHANGELOG.md:557#"The implementer"`) and from line
556 to line 575 (moved again to line 673,
`CHANGELOG.md:934#"Citation scanning is paragraph-joined"`); both were
...
round, `CHANGELOG.md:557#"The implementer"`) and from line 575 to line 579
(moved again to line 673, `CHANGELOG.md:934#"Citation scanning is paragraph-joined"`); both were
...
later change, `CHANGELOG.md:557#"The implementer"`) and from line 579 to
line 598 (moved again to line 673,
`CHANGELOG.md:934#"Citation scanning is paragraph-joined"`), in the two
...
later change, `CHANGELOG.md:557#"The implementer"`) and from line 598 to
line 637 (moved again to line 673,
`CHANGELOG.md:934#"Citation scanning is paragraph-joined"`), in the live
...
later change, `CHANGELOG.md:557#"The implementer"`) and from line 637 to
...
from line 294 to line 296 (`CHANGELOG.md:557#"The implementer"`) and from
...
(`CHANGELOG.md:557#"The implementer"`) and from line 690 to line 718
(`CHANGELOG.md:934#"Citation scanning is paragraph-joined"`); both were
...
(`CHANGELOG.md:557#"The implementer"`) and from line 723 to line 728
(`CHANGELOG.md:934#"Citation scanning is paragraph-joined"`); both were
re-pointed mechanically after checking that each anchor sits on its new
line, in the live sites and in the earlier entries that quote them.
Re-stamped the bundle docs whose `sources:` list `CHANGELOG.md` after
...
(`CHANGELOG.md:557#"The implementer"`) and from line 903 to line 919
(`CHANGELOG.md:934#"Citation scanning is paragraph-joined"`); both were
