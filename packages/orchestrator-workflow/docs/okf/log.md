...
- 2026-09-12T06:30:04Z (mutation probe definition fields, agent-dx task
  ...
  (`implementer.md:104#"take the definition fields from that"`).
...
- 2026-09-12T05:32:21Z (mutation probe definition fields, agent-dx task
  ...
  (`CHANGELOG.md:348#"The implementer"`).
...
- 2026-09-08T11:05:00Z (citation scanning goes paragraph-joined, the
  ...
  (`test/docs-consistency.test.ts:3454#"function collectBrakeScan("`,
  `test/docs-consistency.test.ts:3698#"function collectFullTestCitations("`),
  ...
  (`test/docs-consistency.test.ts:3507#"raises the brake's examined count by exactly one"`):
  ...
  `CHANGELOG.md:725#"Citation scanning is paragraph-joined"`. Verified on
...
- 2026-09-08T10:20:55Z (citation-sibling-drift guard, review round 3 fixes
  ...
  filter
  (`test/docs-consistency.test.ts:3230#"function collectStringAnchoredCitations("`)
  ...
  (`test/docs-consistency.test.ts:3271#"a resolved continuation citation survives collectStringAnchoredCitations"`)
  driving it against
...
- 2026-09-07T12:57:17Z (citation-sibling-drift guard, review round 3, task
  ...
  and
  `packages/orchestrator-workflow/test/acceptance-baseline.test.ts:403-408#"original contract, keep the original checklist semantics"`.
...
- 2026-09-06T21:33:40Z (task 0e17fb63, review round 2 fix round, two
  ...
  `test/docs-consistency.test.ts:4806#"resolve it before the next reviewer spawn"`, a
...
- 2026-09-06T21:10:29Z (task 0e17fb63, review round 1 fix round, six
  ...
  (`test/docs-consistency.test.ts:4491#"never end your turn with the run still outstanding"`).
...
by later rounds, `CHANGELOG.md:348#"The implementer"`) and from line
556 to line 575 (moved again to line 673,
`CHANGELOG.md:725#"Citation scanning is paragraph-joined"`); both were
...
round, `CHANGELOG.md:348#"The implementer"`) and from line 575 to line 579
(moved again to line 673, `CHANGELOG.md:725#"Citation scanning is paragraph-joined"`); both were
...
later change, `CHANGELOG.md:348#"The implementer"`) and from line 579 to
line 598 (moved again to line 673,
`CHANGELOG.md:725#"Citation scanning is paragraph-joined"`), in the two
...
later change, `CHANGELOG.md:348#"The implementer"`) and from line 598 to
line 637 (moved again to line 673,
`CHANGELOG.md:725#"Citation scanning is paragraph-joined"`), in the live
...
later change, `CHANGELOG.md:348#"The implementer"`) and from line 637 to
...
from line 294 to line 296 (`CHANGELOG.md:348#"The implementer"`) and from
...
(`CHANGELOG.md:348#"The implementer"`) and from line 690 to line 718
(`CHANGELOG.md:725#"Citation scanning is paragraph-joined"`); both were
...
has its own entry above. The new heading moved everything below the
`[Unreleased]` heading down by two lines, which shifted this log's two live
self-citations from line 346 to line 348
(`CHANGELOG.md:348#"The implementer"`) and from line 723 to line 725
(`CHANGELOG.md:725#"Citation scanning is paragraph-joined"`); both were
re-pointed mechanically after checking that each anchor sits on its new
line, in the live sites and in the earlier entries that quote them.
Re-stamped the bundle docs whose `sources:` list `CHANGELOG.md` after
