...
timestamp: 2026-09-17T04:42:19Z
sources:
...
- Task-slicer:
  `packages/orchestrator-workflow/assets/skill/references/contracts.md:202#"## Task slicer output contract"`
...
- Advisor (since 0.21.0):
  `packages/orchestrator-workflow/assets/skill/references/contracts.md:274#"would_change_recommendation_if:"`
...
(`packages/orchestrator-workflow/assets/skill/references/contracts.md:202#"## Task slicer output contract"`): `id, title,
...
rule at `packages/orchestrator-workflow/assets/skill/references/contracts.md:250#"rather than inventing new field"`, the
...
(`packages/orchestrator-workflow/assets/skill/references/contracts.md:190#"Review-round escalation budget's trigger."`). The
...
and
`packages/orchestrator-workflow/assets/skill/references/contracts.md:200#"when nothing was withdrawn."`).
