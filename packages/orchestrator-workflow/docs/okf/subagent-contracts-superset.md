...
timestamp: 2026-09-17T04:39:40.280Z
sources:
...
- Task-slicer:
  `packages/orchestrator-workflow/assets/skill/references/contracts.md:208#"## Task slicer output contract"`
...
- Advisor (since 0.21.0):
  `packages/orchestrator-workflow/assets/skill/references/contracts.md:280#"would_change_recommendation_if:"`
...
(`packages/orchestrator-workflow/assets/skill/references/contracts.md:208#"## Task slicer output contract"`): `id, title,
...
rule at `packages/orchestrator-workflow/assets/skill/references/contracts.md:256#"rather than inventing new field"`, the
...
(`packages/orchestrator-workflow/assets/skill/references/contracts.md:196#"Review-round escalation budget's trigger."`). The
...
and
`packages/orchestrator-workflow/assets/skill/references/contracts.md:206#"when nothing was withdrawn."`).
