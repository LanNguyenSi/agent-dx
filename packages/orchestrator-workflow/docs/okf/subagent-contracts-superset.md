...
- Implementer: `packages/orchestrator-workflow/assets/skill/references/contracts.md:101#"## Implementer output contract"`
  vs. `packages/orchestrator-workflow/assets/agents/implementer.md:246#"role: implementer"`.
...
`packages/orchestrator-workflow/assets/skill/references/evidence-and-probes.md:230-231#"only claims that could vary run to run trigger it."` (detailed workflow,
...
(`packages/orchestrator-workflow/assets/skill/references/evidence-and-probes.md:232#"The GitHub Actions shell replay named in step 6 is a second, explicitly"`;
...
result, restored_verified`, `packages/orchestrator-workflow/assets/skill/references/contracts.md:137#"restored_verified:"` and `implementer.md:276#"restored_verified:"`)
...
and
`packages/orchestrator-workflow/assets/agents/implementer.md:277#"replayed: false | true"`),
...
contract itself
(`packages/orchestrator-workflow/assets/skill/references/evidence-and-probes.md:250#"implementer reports as killed together with their mutant definition"`);
...
`packages/orchestrator-workflow/assets/skill/references/evidence-and-probes.md:247#"Review-round escalation budget's trigger (see below) without re-deriving it"`).
...
and `packages/orchestrator-workflow/assets/agents/implementer.md:278#"class_closure:"`,
...
(`packages/orchestrator-workflow/assets/skill/references/evidence-and-probes.md:306#"Halt at the first"`);
...
and `packages/orchestrator-workflow/assets/agents/implementer.md:246#"role: implementer"`,
...
finding first
(`packages/orchestrator-workflow/assets/agents/implementer.md:201#"Before committing, when slop-detector is available run"`),
...
(`packages/orchestrator-workflow/assets/skill/references/evidence-and-probes.md:207-208#"reviewer tier, a budget mismatch that names probes without the effort to run"`);
...
(`packages/orchestrator-workflow/assets/skill/references/evidence-and-probes.md:275#"the probe, the replayed verdict or"`):
