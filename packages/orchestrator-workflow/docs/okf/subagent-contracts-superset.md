...
timestamp: 2026-09-17T05:11:33.000Z
sources:
...
- Task-slicer:
  `packages/orchestrator-workflow/assets/skill/references/contracts.md:213#"## Task slicer output contract"`
...
- Advisor (since 0.21.0):
  `packages/orchestrator-workflow/assets/skill/references/contracts.md:285#"would_change_recommendation_if:"`
...
(`packages/orchestrator-workflow/assets/skill/references/contracts.md:213#"## Task slicer output contract"`): `id, title,
...
rule at `packages/orchestrator-workflow/assets/skill/references/contracts.md:261#"rather than inventing new field"`, the
...
(`packages/orchestrator-workflow/assets/skill/references/contracts.md:201#"Review-round escalation budget's trigger."`). The
...
and
`packages/orchestrator-workflow/assets/skill/references/contracts.md:211#"when nothing was withdrawn."`).
