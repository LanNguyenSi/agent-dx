...
`packages/orchestrator-workflow/assets/skill/references/evidence-and-probes.md:210-211#"only claims that could vary run to run trigger it."` (detailed workflow,
...
(`packages/orchestrator-workflow/assets/skill/references/evidence-and-probes.md:212#"The GitHub Actions shell replay named in step 6 is a second, explicitly"`;
...
contract itself
(`packages/orchestrator-workflow/assets/skill/references/evidence-and-probes.md:230#"implementer reports as killed together with their mutant definition"`);
...
`packages/orchestrator-workflow/assets/skill/references/evidence-and-probes.md:227#"Review-round escalation budget's trigger (see below) without re-deriving it"`).
...
(`packages/orchestrator-workflow/assets/skill/references/evidence-and-probes.md:286#"Halt at the first"`);
...
(`packages/orchestrator-workflow/assets/skill/references/evidence-and-probes.md:187-188#"reviewer tier, a budget mismatch that names probes without the effort to run"`);
...
(`packages/orchestrator-workflow/assets/skill/references/evidence-and-probes.md:255#"the probe, the replayed verdict or"`):
