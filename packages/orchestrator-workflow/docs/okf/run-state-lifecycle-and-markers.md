...
`TODO` falls back to the date heuristic (packages/orchestrator-workflow/CHANGELOG.md:705-710,
...
(CHANGELOG.md:704-717). Pinned by template-markers.test.ts:19,33-37 (exactly
...
(CHANGELOG.md:806-813). Consumer is "the harness solution-acceptance
...
CHANGELOG.md:754-766): a live run had drifted onto
...
CHANGELOG.md:738-748) so the template itself never invites `fix`/`reject`
...
(CHANGELOG.md:628-646). Pinned by
