...
applies unchanged regardless of harness (SKILL.md:713#"applies unchanged.";
SKILL.md:716#"pointer rule from Run state applies unchanged."; SKILL.md:731#"pointer rule from Run state applies unchanged.").
