...
timestamp: 2026-08-25T14:29:03.591Z
sources:
...
`TODO` falls back to the date heuristic (packages/orchestrator-workflow/CHANGELOG.md:683-688,
...
(CHANGELOG.md:682-695). Pinned by template-markers.test.ts:19,33-37 (exactly
...
(CHANGELOG.md:784-791). Consumer is "the harness solution-acceptance
...
CHANGELOG.md:732-744): a live run had drifted onto
...
CHANGELOG.md:716-726) so the template itself never invites `fix`/`reject`
...
(CHANGELOG.md:606-624). Pinned by
