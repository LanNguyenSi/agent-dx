...
packages/orchestrator-workflow/INSTALL-AGENT.md:47-48,135-138). The newest run
...
non-accepting (fail-closed)" (SKILL.md:187-191). A freshly-copied run is
...
run-gate" per SKILL.md:189-190; this doc cites that in-repo statement only, it
...
(SKILL.md:157-160). The runtime half (grounding-mcp's reader treating a
...
`okf-kit check`) (SKILL.md:177-185). It is explicitly non-gating: "apply
this optional guidance" and "Repos without a bundle are unaffected"
(SKILL.md:177-178,172-173). This is the symmetric counterpart to the 0.8.0
